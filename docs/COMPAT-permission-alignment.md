...
|-------|------|------------|--------|--------|-----------|--------|
| code-smeller | hygiene | Write | PASS | PASS | PASS | PASS |
| user-researcher | intelligence | Edit | PASS | PASS | PASS | PASS |
| technology-scout | rnd | Edit | PASS | PASS | PASS | PASS |
| penetration-tester | security | Edit | PASS | PASS | PASS | PASS |
| threat-modeler | security | Edit | PASS | PASS | PASS | PASS |
...
| File | Result |
|------|--------|
| `rites/hygiene/agents/code-smeller.md` | VALID |
| `rites/intelligence/agents/user-researcher.md` | VALID |
| `rites/rnd/agents/technology-scout.md` | VALID |
| `rites/security/agents/penetration-tester.md` | VALID |
| `rites/security/agents/threat-modeler.md` | VALID |
...
```
/roster/rites/hygiene/agents/code-smeller.md
/roster/rites/intelligence/agents/user-researcher.md
/roster/rites/rnd/agents/technology-scout.md
/roster/rites/security/agents/penetration-tester.md
/roster/rites/security/agents/threat-modeler.md
```
...
*Report generated by Compatibility Tester (ecosystem)*
