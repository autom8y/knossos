...
| **Heroes** | Specialist agents via Agent tool | `rites/*/agents/`, `agents/` | Tier 4 — functional analogy | Summoned mid-journey with clew context. 110 agents across 19 rites. |
