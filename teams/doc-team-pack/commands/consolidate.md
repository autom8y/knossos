...
This command orchestrates the ecosystem-pack workflow for documentation consolidation:
...
Full workflow documentation: `.claude/skills/doc-consolidation/SKILL.md`
Agent details: `.claude/agents/orchestrator.md`
