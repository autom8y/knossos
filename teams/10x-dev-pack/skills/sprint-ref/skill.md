...
| Missing team agents | Required agent not in active team | Switch to 10x-dev-pack with `/10x` |
...
- [documentation](../documentation/SKILL.md) - Artifact templates
- [task](../task/SKILL.md) - Single task execution skill
