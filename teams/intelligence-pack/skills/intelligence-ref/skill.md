...
description: "Product Intelligence team reference with analytics, user research, and experimentation workflows. Use when: learning about intelligence-pack agents, understanding the analytics workflow, invoking intelligence agents. Triggers: intelligence-pack, product intelligence, analytics-engineer, user-researcher, experimentation-lead, insights-analyst."
---

# Product Intelligence Team (intelligence-pack)
...
**Don't use intelligence-pack when:**
- Building features → Use 10x-dev-pack
- Security analysis → Use security-pack
