...
For complete PRD structure and expanded quality checklist, see [prd-template](../doc-artifacts/prd-template.md).
...
For complete TDD structure and expanded quality checklist, see [tdd-template](../doc-artifacts/tdd-template.md).
...
For complete Test Plan structure and expanded quality checklist, see [test-templates](../doc-artifacts/test-templates.md).
