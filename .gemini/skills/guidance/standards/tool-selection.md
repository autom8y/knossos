...
**Decision**: For new Python/Go projects, prefer `just` with modular organization. See [justfile skill](../../templates/justfile/SKILL.md).

## Development Commands

**Preferred**: Use `just` for task automation. See [justfile skill](../../templates/justfile/SKILL.md) for patterns.
