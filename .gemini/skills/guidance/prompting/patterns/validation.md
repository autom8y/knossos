...
> Copy-paste prompts for testing, validation, and quality checks. For agent invocation patterns, see [INDEX.lego.md](../SKILL.md#quick-reference-agent-invocation).
