...
- `pinakes/domains/feature-census.md` -- Census audit criteria (how the census is graded)
- `pinakes/domains/feature-knowledge.md` -- Per-feature knowledge audit criteria (how feature files are graded)
