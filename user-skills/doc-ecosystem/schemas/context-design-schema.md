...
| `affected_systems` | array | skeleton, roster, CEM | context-architect |
...
6. `affected_systems` MUST be array with at least one of: skeleton, roster, CEM
