...
**Supporting context**: `internal/validation/schemas/complaint.schema.json` (required fields and allowed values), `rites/shared/mena/complaint-filing/INDEX.lego.md` (filing protocol)
...
- [complaint-filing skill](../../../../rites/shared/mena/complaint-filing/INDEX.lego.md) - Filing protocol and schema
- [hooks-criteria](hooks.lego.md) - Hook wiring audit (driftdetect hook contributes to filing volume)
