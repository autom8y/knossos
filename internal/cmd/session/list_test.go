...
//
// staleSessionThreshold() reads ARIADNE_STALE_SESSION_DAYS env var to
...
func TestStaleSessionThreshold_Default(t *testing.T) {
	...
	os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
...
func TestStaleSessionThreshold_EnvOverride(t *testing.T) {
	os.Setenv("ARIADNE_STALE_SESSION_DAYS", "5")
	defer os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
...
func TestStaleSessionThreshold_InvalidEnv(t *testing.T) {
	...
	os.Setenv("ARIADNE_STALE_SESSION_DAYS", "abc")
	defer os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
...
func TestStaleSessionThreshold_Zero(t *testing.T) {
	...
	os.Setenv("ARIADNE_STALE_SESSION_DAYS", "0")
	defer os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
...
func TestStaleSessionThreshold_Negative(t *testing.T) {
	...
	os.Setenv("ARIADNE_STALE_SESSION_DAYS", "-3")
	defer os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
...
func TestStaleSessionThreshold_LargeValue(t *testing.T) {
	...
	os.Setenv("ARIADNE_STALE_SESSION_DAYS", "365")
	defer os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
...
func TestStaleSessionThreshold_EmptyString(t *testing.T) {
	...
	os.Setenv("ARIADNE_STALE_SESSION_DAYS", "")
	defer os.Unsetenv("ARIADNE_STALE_SESSION_DAYS")
