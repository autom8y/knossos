	...
	"orchestrator": {
		...
		Sections: []SectionDef{
			...
			{Name: "position-in-workflow", Heading: "## Position in Workflow", Ownership: OwnerDerived,
				TodoHint: ""},
			{Name: "domain-authority", Heading: "## Domain Authority", Ownership: OwnerAuthor,
				TodoHint: "Define what this agent decides vs. escalates"},
	...
	"specialist": {
		...
		Sections: []SectionDef{
			...
			{Name: "position-in-workflow", Heading: "## Position in Workflow", Ownership: OwnerDerived,
				TodoHint: ""},
			{Name: "domain-authority", Heading: "## Domain Authority", Ownership: OwnerAuthor,
				TodoHint: "Define what this agent decides vs. escalates vs. routes"},
			{Name: "tool-access", Heading: "## Tool Access", Ownership: OwnerDerived,
				TodoHint: ""},
	...
	"reviewer": {
		...
		Sections: []SectionDef{
			...
			{Name: "position-in-workflow", Heading: "## Position in Workflow", Ownership: OwnerDerived,
				TodoHint: ""},
			{Name: "domain-authority", Heading: "## Domain Authority", Ownership: OwnerAuthor,
				TodoHint: "Define what this reviewer decides, escalates, and routes back"},
			{Name: "quality-standards", Heading: "## Quality Standards", Ownership: OwnerAuthor,
