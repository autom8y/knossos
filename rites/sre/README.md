...
## Handoff Acceptance from 10x-dev

SRE accepts validation handoffs from 10x-dev for production readiness assessment.
...
- **10x-dev**: Primary source of validation handoffs for new features
- **debt-triage**: When reliability issues stem from accumulated technical debt
