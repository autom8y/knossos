...
- Proper coach pattern for Potnia (consultative, not executing)
...
- [ ] Define integration pattern:
  ...
  **Workflow**:
  ...
  2. User/Potnia routes to strategy for business case validation
...
- [ ] Add routes:
  ...
  back_routes:
    ...
    - from: business-model-analyst
      ...
      requires_confirmation: false
  ```
- [ ] Document in Potnia guidance: When to trigger each back-route
