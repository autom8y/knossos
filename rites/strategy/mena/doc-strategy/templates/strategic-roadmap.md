...
**Strategic Roadmap complete when:**
- Initiatives scored against weighted criteria
- Resource allocation sums to available capacity
- OKRs have measurable key results
- Decision points include timing and triggers
