---
name: debt-ref
description: "Quick switch to debt-triage-pack (technical debt management). Use when: inventorying technical debt, prioritizing remediation, planning debt paydown sprints, assessing codebase health. Triggers: /debt, debt team, debt triage, debt planning, technical debt."
---
...
1. Switches to debt-triage-pack
...
- Update `active_team` field to `debt-triage-pack`
...
Output:
```
[Roster] Switched to debt-triage-pack (3 agents loaded)
...
- Team switched to debt-triage-pack
...
- [standards](../standards/SKILL.md) - Quality standards to compare against
