...
When moonshot-architect produces a MOONSHOT artifact with significant business implications, it triggers a handoff to strategy-pack for roadmap integration.
...
2. If `business_impact > "significant"`, initiate handoff to strategy-pack
