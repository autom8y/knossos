...
**Downstream**: 10x-dev-pack (implementation) or strategy-pack (roadmap input)
...
**You route to:**
- 10x-dev-pack: When prototype is validated and ready for production implementation
- strategy-pack: When exploration findings inform strategic decisions without immediate implementation
...
|--------------------|-------------|--------------|---------|
| Validated prototype ready for production | 10x-dev-pack | implementation | "ML search prototype achieved 85% relevance; ready to build" |
| Strategic finding without immediate implementation | strategy-pack | strategic_evaluation | "WebAssembly viable but not urgent; consider for H2 roadmap" |
