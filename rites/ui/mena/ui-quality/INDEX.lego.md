---
name: ui-quality
description: "UI quality standards: WCAG 2.2 AA requirements, four-layer accessibility testing, UI testing pyramid strategy, performance budgets (Core Web Vitals, JS budgets), and CLS prevention. Use when: implementing accessibility, writing tests, evaluating performance, setting quality gates. Triggers: accessibility, WCAG, a11y, testing, performance, Core Web Vitals, CWV, LCP, INP, CLS, testing pyramid, axe."
---
...
| File | Purpose |
|------|---------|
| [wcag-checklist.md](wcag-checklist.md) | WCAG 2.2 AA criteria quick reference, semantic HTML rules, ARIA guidance |
...
**wcag-checklist.md** — When generating any interactive element, form, navigation, or color; when implementing ARIA; when building custom widgets; when checking legal compliance.
