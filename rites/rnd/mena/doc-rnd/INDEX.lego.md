...
> Templates for research and development workflow artifacts.

## Purpose

Provides structured templates for R&D workflows: technology evaluation with adopt/hold verdicts, integration analysis with effort estimation, prototype documentation with feasibility assessment, and long-term architectural planning with scenario analysis.
...
| Scenario | Template |
|----------|----------|
| Evaluating a new technology | Tech Assessment |
| Planning a system integration | Integration Map |
| Documenting prototype results | Prototype Doc |
...
|----------|---------------|
| **Tech Assessment** | Adopt/Trial/Assess/Hold/Avoid verdict, comparison matrix, ecosystem assessed |
...
- [tech-assessment.md](templates/tech-assessment.md) - Technology evaluation (SCOUT-{slug})
