...
**Tech Assessment complete when:**
- Verdict follows Radar taxonomy (Adopt/Trial/Assess/Hold/Avoid)
- Ecosystem assessment covers community, docs, tooling, adoption
- Comparison matrix includes at least one alternative
- Risk analysis has mitigations for high-impact risks
