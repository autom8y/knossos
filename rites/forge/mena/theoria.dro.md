...
- `mena/pinakes/domains/*.md` — domain criteria files
...
- `mena/pinakes/schemas/report-format.md` — Report format specification
- `mena/pinakes/schemas/grading.md` — Grading calculation rules
