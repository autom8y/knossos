...
| Security/compliance docs | | security-pack |
| Operational runbooks | | sre-pack |
| Test documentation | | 10x-dev-pack |
...
| Item | Depends On |
|------|------------|
| P1 (10x gate) | Changes to 10x-dev-pack/agents/qa-adversary.md |
...
Continue audit with: **hygiene-pack** (code quality and refactoring)
