...
See also: [intelligence-pack README](../intelligence-pack/README.md#when-to-use-intelligence-vs-strategy)

## Architecture Strategy Integration

**Workflow**: moonshot-architect (RND) -> roadmap-strategist (Strategy)

When RND's moonshot-architect produces a MOONSHOT artifact with `business_impact > "significant"`, it triggers handoff to strategy-pack for roadmap integration.
...
- **rnd-pack**: Receive moonshot architecture plans for strategic integration
