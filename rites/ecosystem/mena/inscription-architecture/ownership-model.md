...
|----------------|-------|---------------|-------|
| `# Context File` | Knossos | SYNC | Title and tagline |
...
4. WHAT is happening now?
   ...
   - Session phase
   - Handoff context
   └─> Session state, NOT in context file
```
...
**Wrong**:
```markdown
# satellite context file (after sync)
...
|-------|----------|---------|-------------|
| Global | `~/.channel/CLAUDE.md` | Personal preferences | User |
| Project | `.channel/CLAUDE.md` | Rite + Project + Infrastructure | sync pipeline, knossos |
