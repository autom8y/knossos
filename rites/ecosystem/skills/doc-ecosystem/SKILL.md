...
- [documentation](~/.claude/skills/documentation/SKILL.md) - Core artifact templates (PRD, TDD, ADR)
- [standards](~/.claude/skills/standards/SKILL.md) - Code conventions and repository structure
