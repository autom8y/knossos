...
For quick anti-pattern detection patterns, see the **Anti-Pattern Summary** table in [SKILL.md](SKILL.md#anti-pattern-summary) (lines 171-184), which includes the "Core Issue" column explaining why each pattern matters.
