...
Switch to the Product Intelligence Team pack and display the rite roster. $ARGUMENTS

## Behavior

1. Execute: `${KNOSSOS_HOME:-~/Code/roster}/swap-rite.sh intelligence $ARGUMENTS`
